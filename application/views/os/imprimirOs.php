...
<head>
    <title>Imprimir Ordem de Serviço de <?php echo $result->idOs ?>_<?php echo $result->nomeCliente ?></title>
    <meta charset="UTF-8" />
                ...
                <div class="invoice-content">
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        ...
                        <?php if ($servicos != null) { ?>
                            ...
                            <tbody>
                                <tr>
                                    <th colspan="1" style="vertical-align: middle;font-size: 13px;width: 71%;">Valor Total do Serviço</th>
                                    <td>
                                    <?php } ?>
                                    <?php
