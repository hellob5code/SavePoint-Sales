...
<head>
    <title>Impressão Não Fiscal</title>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/bootstrap.min.css" />
    <link rel="shortcut icon" type="image/png" href="http://vassouras.savepointgame.com.br/assets/img/favicon.png">
                            ...
                            <tbody>
                                ...
                                <?php if ($result->dataInicial != null) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <b>Inicial: </b>
                                            <p><?php echo date('d/m/Y', strtotime($result->dataInicial)); ?></p>
                                        </td>

                                        <td>
                                            <b>Final: </b>
                                            <p><?php echo $result->dataFinal ? date('d/m/Y', strtotime($result->dataFinal)) : ''; ?></p>
                                        </td>

                                        <td>
                                            <?php if ($result->garantia != null) { ?>
                                                <b>Garantia: </b>
                                                <p><?php echo $result->garantia . ' dias'; ?><?php } ?></p>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"> <?php
                                                        if ($totalProdutos != 0 || $totalServico != 0) {
                                                            echo "<h4 style='text-align: right; font-size: 13px;'>R$" . number_format($totalProdutos + $totalServico, 2, ',', '.') . "</h4>";
                                                        }
