    ...
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vProduto')) : ?>
                <li class="bg_lg">
                    <a href="<?= base_url() ?>index.php/produtos"> <i class="fas fa-gamepad" style="font-size:36px"></i>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
                <li class="bg_lo">
                    <a href="<?= base_url() ?>index.php/os"> <i class="fas fa-diagnoses" style="font-size:36px;"></i>
                        <div>Ordem de Serviço <span class="badge badge-light">F4</span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) : ?>
                <li class="bg_ls">
                    <a href="<?= base_url() ?>index.php/vendas"><i class="fas fa-dollar-sign" style="font-size:36px"></i>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vGarantia')) : ?>
                <li class="bg_ls">
                    <a href="<?= base_url() ?>index.php/garantias"><i class="fas fa-book" style="font-size:36px"></i>
                        <div>Termos de Garantia <span class="badge badge-light">F7</span></div>
                    </a>
                </li>
            <?php endif ?>
        </ul>
